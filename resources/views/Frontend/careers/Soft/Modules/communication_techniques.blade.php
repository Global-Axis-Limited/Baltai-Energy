    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mb-4">
                ...
                <p>Equip SRMs with effective communication strategies to build relationships, enhance customer trust, and increase sales.</p>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 1. Importance of Effective Communication in Sales
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 2. Essential Communication Skills for SRMs
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 3. Active Listening Techniques
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 4. Verbal Communication: How to Speak Effectively
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 5. Non-Verbal Communication: Body Language & Voice Tone
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 6. Handling Customer Questions & Concerns
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 7. Closing Conversations & Follow-Ups
                                    </a>
                                </td>
                            </tr>
                        </tbody>
