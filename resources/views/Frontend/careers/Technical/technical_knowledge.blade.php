    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="text">
                    <p>
                   <a href="{{route('index')}}">Home</a> >> <a href="{{route('baltai')}}">Baltai Learning</a> >> Technical Knowledge for SRMs
                    </p>
                </div>
            </div>
        </div>
...
<section class="insights-section">
    <div class="container">
        <h2 class="text-left mb-3">Technical Knowledge for SRMs</h2>
        <p class="mb-4">
        Provide technical knowledge necessary to explain solar system operations and address basic customer concerns.
        </p>
        <p class="mb-5"></p>
        <div class="row mt-5">
            <!-- Card 1 -->
