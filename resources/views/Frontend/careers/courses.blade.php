    ...
    <div class="container mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap mb-5">
            <div class="categories">
                <h1 class="fw-medium">Available Courses</h2>
        ...
        <div class="row mt-4" id="coursesContainer">
            ...
            <div class="col-md-4 mb-4 course-item">
                <div class="card course-card">
                    <img src="https://res.cloudinary.com/ddj0k8gdw/image/upload/v1737285723/Energy/image2_hkepaj.jpg" class="card-img-top" alt="Communication">
                    <div class="card-body">
