    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-8 mb-4">
                ...
                <p>Equip SRMs with strategies to foster long-term customer loyalty, turning satisfied clients into advocates for Baltai Energy’s Solar Solutions Network.</p>
                            ...
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 1. Importance of Customer Loyalty
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 2. Key Components of Building Loyalty
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 3. Strategies for Long-Term Loyalty
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 4. Tools for Building Loyalty
                                    </a>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <a href="#" class="course-link">
                                        <i class="bi bi-play-circle"></i> 5. Measuring Customer Loyalty
                                    </a>
                                </td>
                            </tr>
                        </tbody>
