    ...
    <header>
        <div class="bg-dark text-white pt-3 pb-3 fixed-top" id="header-scroll">
            <div class="container d-flex justify-content-between ">
                <div class="">
                    <a href="https://www.instagram.com/baltaienergy/" class="text-white me-4"><i
                            class="bi bi-instagram"></i></a>
                    <a href="https://www.linkedin.com/company/baltai-energy/" class="text-white me-4"><i
                            class="bi bi-linkedin"></i></a>
                    <a href="https://www.facebook.com/baltaienergy/" class="text-white me-4"><i
        ...
        <nav class="navbar navbar-expand-lg fixed-top" id="header-scroll">
            <div class="container">
                <a href="{{route('index')}}" class="navbar-brand">
                    <img src="https://res.cloudinary.com/ddj0k8gdw/image/upload/v1736857400/Energy/p_1_w9bqwe.png"
                        draggable="false" alt="">
                </a>
                ...
                <div class="offcanvas offcanvas-end" tabindex="-100" id="offcanvasNavbar"
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-center flex-grow-1">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle" href="{{route('solution')}}"
                                    {{ (request()->is('solution*')) ? 'active' : '' }}>
                                    Solution
                                </a>
                                <ul class="dropdown-menu">
                                    <li><a href="{{route('product')}}" class="dropdown-item"><i class="bi bi-house"></i>
                                            Residential Solutions</a></li>
                                    <li><a href="{{route('business')}}" class="dropdown-item"><i
                                                class="bi bi-house-heart"></i> Business Solutions</a></li>
                                    <li><a href="{{route('industrial')}}" class="dropdown-item"><i
                                                class="bi bi-houses"></i> Industrial Solutions</a></li>
                                </ul>
                            </li>
                            <!-- -->
                            <li class="nav-item">
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{route('baltai')}}" class="dropdown-item">Learning</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
        ...
        <div class="offcanvas offcanvas-end offcanvas-contact-hambuger" data-bs-scroll="true" tabindex="-1"
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.addEventListener("click", function(event) {
        if (!document.querySelector(".search-box").contains(event.target) && event.target !==
            searchIcon) {
            searchOverlay.style.display = "none";
        }
    });
    ...
    function searchOnPage(query) {
        ...
        if (index !== -1) {
            ...
            const highlightedSnippet = snippet.replace(new RegExp(query, "gi"), match =>
                `<mark>${match}</mark>`);
        ...
        for (const page of allPages) {
            ...
            if (index !== -1) {
                ...
                resultItem.innerHTML =
                    `<a href="${page.link}"><strong>${page.title}</strong></a> <p>${highlightedSnippet}...</p>`;
                searchResults.appendChild(resultItem);
            }
        }
